...
from .views import generate_risks_pdf, add_risk_identification, add_risk_evaluation, add_risk_treatment, add_contingency_plan, add_reevaluation, get_evaluation_suggestions, get_treatment_suggestions
from . import views
...
urlpatterns = [
  ...
  path('get-evaluation-suggestions/', get_evaluation_suggestions, name='get_evaluation_suggestions'),
