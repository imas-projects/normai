...
from .views import generate_risks_pdf, add_risk_identification, add_risk_evaluation, add_risk_treatment, add_contingency_plan, add_reevaluation, get_controls_suggestions, get_ranges_suggestions, get_level_suggestions, get_treatment_suggestions, get_contingency_suggestions, get_reevaluation_ranges_suggestions, get_reevaluation_level_suggestions
from . import views
...
urlpatterns = [
  ...
  path('get-reevaluation-range-suggestions/', get_reevaluation_ranges_suggestions, name='get_reevaluation_ranges_suggestions'),
  path('get-reevaluation-risk-level/', get_reevaluation_level_suggestions, name='get_reevaluation_level_suggestions'),
