...
class Area(models.Model):
    ...
    users = models.ManyToManyField(User, related_name="users", verbose_name="Area Users")  # Un área puede tener varios usuarios y cada usuario estar en más de un area
